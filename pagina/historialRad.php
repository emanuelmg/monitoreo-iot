        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Historial">
          ...
          <ul class="sidenav-second-level collapse" id="collapseHistorial">
            ...
            <li>
             ...
             <li>
              <a href="historialLux.php">Radiación</a>
            </li>
          </ul>
        </li>
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-area-chart"></i>Radiación</div>
          <div class="card-body">
             <?php include'rad.php'; ?>
             <div id="lux" style="height: 400px; min-width: 310px"></div>
          </div>
        </div>
      </div>
    ...
    chartCPU1 = new Highcharts.StockChart({
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $luxArray[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
