...
function conectarBD1(){ 
    ...
    $sql = "SELECT fecha,temp_int,temp_ext,hum_int,hum_ext FROM sistema;";
    ...
    for($i = 0 ;$i<count($rawdata);$i++){
        $temp1Array[$i]= $rawdata[$i][1];
        $hum1Array[$i]= $rawdata[$i][3];
        $temp2Array[$i]= $rawdata[$i][2];
        $hum2Array[$i]= $rawdata[$i][4];
