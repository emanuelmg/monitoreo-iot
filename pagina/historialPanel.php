    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-area-chart"></i>Panel</div>
          <div class="card-body">
             <?php include'panel.php'; ?>
             <div id="vpanel" style="height: 400px; min-width: 310px"></div>
             <br />
             <div id="ipanel" style="height: 400px; min-width: 310px"></div>
             <br />
             <div id="wpanel" style="height: 400px; min-width: 310px"></div>
          </div>
        </div>
      </div>
    ...
    chartCPU1 = new Highcharts.StockChart({
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $vpanelArray[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $ipanelArray[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $wpanelArray[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
