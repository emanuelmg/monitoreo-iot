    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-area-chart"></i>Temperatura/Humedad</div>
          <div class="card-body">
             <?php include'temp.php'; ?>
             <div id="temp1" style="height: 400px; min-width: 310px"></div>
             <br />
             <div id="hum1" style="height: 400px; min-width: 310px"></div>
             <br />
             <div id="temp2" style="height: 400px; min-width: 310px"></div>
             <br />
             <div id="hum2" style="height: 400px; min-width: 310px"></div>
          </div>
        </div>
      </div>
    ...
    chartCPU1 = new Highcharts.StockChart({
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $temp2Array[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $hum1Array[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $hum2Array[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
