...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-area-chart"></i>Estado de la Batería</div>
          <div class="card-body">
             <?php include'bat.php'; ?>
             <div id="vbat" style="height: 400px; min-width: 310px"></div>
             <br />
             <div id="tbat" style="height: 400px; min-width: 310px"></div>
          </div>
        </div>
      </div>
    ...
    chartCPU1 = new Highcharts.StockChart({
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $vbatArray[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
    ...
    chartCPU2 = new Highcharts.StockChart({
        ...
        title: {
            text: 'Temperatura de la Batería'
        },
        xAxis: {
            type: 'datetime'
            //tickPixelInterval: 150,
        ...
        series: [{
            ...
            data: (function() {
                    ...
                    <?php
                        for($i = 0 ;$i<count($rawdata);$i++){
                    ?>
                    data.push([<?php echo $timeArray[$i];?>,<?php echo $tbatArray[$i];?>]);
                    <?php } ?>
                    return data;
                })()
        }],
